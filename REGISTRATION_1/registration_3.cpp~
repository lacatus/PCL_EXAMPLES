...
main (int argc, char* argv[])
{
	...
	// Cloud 1
	pcl::PointCloud<pcl::PointXYZRGBA>::Ptr cloud_in 	(new pcl::PointCloud<pcl::PointXYZRGBA>); // Original point cloud
	pcl::PointCloud<pcl::PointXYZRGBA>::Ptr cloud_input	(new pcl::PointCloud<pcl::PointXYZRGBA>); // Original point cloud
	pcl::PointCloud<pcl::PointXYZRGBA>::Ptr cloud_tr	(new pcl::PointCloud<pcl::PointXYZRGBA>); // Transformed point cloud
	pcl::PointCloud<pcl::PointXYZRGBA>::Ptr cloud_icp	(new pcl::PointCloud<pcl::PointXYZRGBA>); // ICP output point cloud

	// Cloud 2
	pcl::PointCloud<pcl::PointXYZRGBA>::Ptr cloud_in_2	(new pcl::PointCloud<pcl::PointXYZRGBA>); // Original point cloud
	pcl::PointCloud<pcl::PointXYZRGBA>::Ptr cloud_input_2	(new pcl::PointCloud<pcl::PointXYZRGBA>); // Original point cloud
	pcl::PointCloud<pcl::PointXYZRGBA>::Ptr cloud_tr_2	(new pcl::PointCloud<pcl::PointXYZRGBA>); // Transformed point cloud
	pcl::PointCloud<pcl::PointXYZRGBA>::Ptr cloud_icp_2	(new pcl::PointCloud<pcl::PointXYZRGBA>); // ICP output point cloud
	...
	approximate_voxel_filter_2.setLeafSize (0.01, 0.01, 0.01);
	...
	*/	
	...
	pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZRGBA> cloud_in_color_h (cloud_in, (int)255* txt_gray_lvl, (int)255* txt_gray_lvl, (int)255* txt_gray_lvl);
	viewer.addPointCloud (cloud_in, cloud_in_color_h, "cloud_in");
	
	// ICP aligned point cloud is red
	pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZRGBA> cloud_in_2_color_h (cloud_in_2, 180, 20, 20);
	viewer.addPointCloud (cloud_in_2, cloud_in_2_color_h, "cloud_in_2");
	...
	while(!viewer.wasStopped ())
	{
		...
		if (next_iteration) {
			...
			if (icp.hasConverged()) {
				...
				viewer.updatePointCloud (cloud_in_2, cloud_in_2_color_h, "cloud_in_2");
			} else {
				PCL_ERROR ("\nICP has not converged.\n");
				return -1;
			}
	...
	pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZRGBA> cloud_tr_color_h (cloud_tr, 20, 180, 20);
	viewer.addPointCloud (cloud_tr, cloud_tr_color_h, "cloud_tr_v1", v1);

	// ICP aligned point cloud is red
	pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZRGBA> cloud_icp_color_h (cloud_icp, 180, 20, 20);
