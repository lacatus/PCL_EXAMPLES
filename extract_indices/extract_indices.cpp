...
pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ>  cloud_p_color_handler ( cloud_p, 0, 0, 0); // Where 255,255,255 are R,G,B colors
...
viewer.setPointCloudRenderingProperties (pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 2, "Plane");
  ...
  while (cloud_filtered->points.size () > 0.3 * nr_points)
  {
	...
	viewer.addPointCloud  (cloud_p,  cloud_p_color_handler, "Plane");	// We add the point cloud to the viewer and pass the color handler
